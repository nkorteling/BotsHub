...
Func createGUI()
	...
	$GUI_Checkbox_ProtectQ9 = GUICtrlCreateCheckbox('Protect Q9- Weapons', 31, 254, 120, 20)
	$GUI_Checkbox_ProtectGreens = GUICtrlCreateCheckbox('Protect Green Items', 31, 274, 120, 20)
	$GUI_Checkbox_ProtectKeys = GUICtrlCreateCheckbox('Protect Keys', 31, 294, 120, 20)
	$GUI_Checkbox_ProtectScrolls = GUICtrlCreateCheckbox('Protect Scrolls', 31, 314, 120, 20)

	; Protect group (right column)
	$GUI_Checkbox_ProtectMods = GUICtrlCreateCheckbox('Protect Mods', 170, 254, 100, 20)
	$GUI_Checkbox_ProtectInscriptions = GUICtrlCreateCheckbox('Protect Inscriptions', 170, 274, 100, 20)
	$GUI_Checkbox_ProtectRunes = GUICtrlCreateCheckbox('Protect Runes', 170, 294, 100, 20)
